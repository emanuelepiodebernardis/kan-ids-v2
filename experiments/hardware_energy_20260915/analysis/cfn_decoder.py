    ...
    if 0 in indices and 1 in indices:
        ...
        if 6 in indices:
            ...
            metadata["NRG_crosscheck"] = {
                ...
                "ratio_to_integrated_VI_energy": nrg_delta*3600/energy,
                "integrated_VI_energy_divided_by_NRG_delta": energy/(nrg_delta*3600),
                "status": "INCONSISTENT_WITH_RECORDED_POWER_AND_TIME" if abs(nrg_delta*3600/energy-1)>0.01 else "NUMERICALLY_CONSISTENT",
