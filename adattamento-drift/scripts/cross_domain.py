...
def build_models(cardinalities, seed, wanted=None, multilayer=True, in_dim=K_NUMERIC):
    ...
    K_NUMERIC: coincidono solo perche' lo spazio ricco ha 13 candidate e
    k=10. Correzione difensiva: lo stesso difetto (in_dim fisso) e' esploso
    in joint_training.py nella radice quando le candidate erano meno di 10
    (spazio ridotto); qui questo script gira solo nello spazio ricco quindi
    non ha mai fatto danno, ma il difetto era identico e latente."""
    models = {
