...
140 invariate, bit per bit. **Riverificato dopo, sul run completo: 28.000
celle sui cinque rapporti, differenza massima 0,0** — non "trascurabile":
zero. Il test
`tests/test_guardia_monoclasse.py::test_le_sette_politiche_non_si_muovono`
lo ricontrolla ogni volta, e fallisce se una si muove.
