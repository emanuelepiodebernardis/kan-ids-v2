...
\urlstyle{same}
\hypersetup{pdftitle={Decision-Agreement Certificates for Integer Additive Kolmogorov-Arnold Networks: A Microcontroller Case Study in IoT Intrusion Detection},pdfauthor={Oleksandr Kuznetsov; Emanuele Pio De Bernardis; Emanuele Frontoni},pdfsubject={Paper 1 IEEE Access working manuscript v0.15.1}}
...
\newcommand{\kanidsdraftfoot}{\hbox to\textwidth{{\footervolfont Working manuscript, version 0.15.1}\hfill{\footerpagefont\thepage}}}
