...
\begin{table*}[p]
\centering
\caption{Joint-model results in the rich harmonized space. Values are means $\pm$ sample SD on the 0--1 scale across ten fits (seeds 42--51). Final fitting uses 4,584 equally contributed source observations. Normal recall equals $1-\mathrm{FPR}$. Class denominators are 10,000 normal/32,209 attack for TON, 95/733,610 for BoT and 93,000/164,673 for UNSW. One BoT normal error changes normal recall by 1.05 percentage points and BA by 0.526 points. Reused seeds are not independent new networks.}
